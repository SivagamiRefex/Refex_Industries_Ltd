# Cursor Prompt: Complete SMTP Email Configuration Setup

Use this prompt in Cursor to set up a complete SMTP email service for contact forms in any Node.js/Express project.
...
## Additional Notes for Different Projects:
...
### For Custom SMTP:
- Use your mail server's SMTP host
- Port 587 (TLS) or 465 (SSL)
- Set secure: true for port 465

### Frontend Integration:
The frontend should send POST request to `/api/contact-form` with this structure:
```json
{
  "fullName": "John Doe",
...
- [ ] Create email_service.js with all three methods
- [ ] Create contact.js route with validation
- [ ] Add SMTP variables to .env file
