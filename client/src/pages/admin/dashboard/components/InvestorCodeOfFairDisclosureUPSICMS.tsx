...
export default function InvestorCodeOfFairDisclosureUPSICMS() {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900">Code of Fair Disclosure UPSI Page CMS</h2>
        <p className="text-sm text-gray-600 mt-1">Manage documents for the Code of Fair Disclosure UPSI page</p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="md:col-span-2">
              ...
              <input
                ...
                placeholder="e.g., Code of Fair Disclosure UPSI"
              />
            </div>
            <div className="md:col-span-2">
              <label className="block text-sm font-medium text-gray-700 mb-2">
              ...
              <div className="flex items-center gap-4 mb-2">
                <input
                  ...
                  className="hidden"
                  id="codeOfFairDisclosurePdfUpload"
                  disabled={uploadingPdf}
                />
                <label
                  htmlFor="codeOfFairDisclosurePdfUpload"
