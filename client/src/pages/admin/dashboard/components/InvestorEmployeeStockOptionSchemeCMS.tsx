...
export default function InvestorEmployeeStockOptionSchemeCMS() {
  ...
  const handleSave = async () => {
    try {
      ...
      let existingPage;
      try {
        existingPage = await investorsCmsApi.getPageContentBySlug('employee-stock-option-scheme');
      } catch (e) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900">Employee Stock Option Scheme Page CMS</h2>
        <p className="text-sm text-gray-600 mt-1">Manage documents for the Employee Stock Option Scheme page</p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              placeholder="Employee Stock Option Scheme"
            />
          </div>
