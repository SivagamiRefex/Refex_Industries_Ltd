...
export default function InvestorInvestorPresentationCMS() {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900">Investor Presentation Page CMS</h2>
        <p className="text-sm text-gray-600 mt-1">Manage documents for the Investor Presentation page</p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="md:col-span-2">
              ...
              <input
                ...
                placeholder="e.g., RIL-Investor Presentation-Q2 FY26"
              />
            </div>
            {pageContent.hasYearFilter && (
              <div>
            ...
            <div className={pageContent.hasYearFilter ? '' : 'md:col-span-2'}>
              ...
              <div className="flex items-center gap-4 mb-2">
                <input
                  ...
                  className="hidden"
                  id="presentationPdfUpload"
                  disabled={uploadingPdf}
                />
                <label
                  htmlFor="presentationPdfUpload"
