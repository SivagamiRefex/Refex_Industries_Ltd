...
export default function InvestorMonitoringAgencyReportCMS() {
  ...
  const handlePdfUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // Upload to monitoring-agency-report subfolder
  ...
  const handleSave = async () => {
    try {
      ...
      let existingPage;
      try {
        existingPage = await investorsCmsApi.getPageContentBySlug('monitoring-agency-report');
      } catch (e) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900">Monitoring Agency Report Page CMS</h2>
        <p className="text-sm text-gray-600 mt-1">Manage documents for the Monitoring Agency Report page</p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              placeholder="Monitoring Agency Report"
            />
          </div>
            ...
            <div className="md:col-span-2">
              ...
              <div className="flex items-center gap-4 mb-2">
                <input
                  ...
                  className="hidden"
                  id="monitoringAgencyPdfUpload"
                  disabled={uploadingPdf}
                />
                <label
                  htmlFor="monitoringAgencyPdfUpload"
