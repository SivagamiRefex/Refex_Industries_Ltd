...
export default function InvestorAnnualReturnCMS() {
  ...
  const handlePdfUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // Upload to annual-return subfolder
  ...
  const handleSave = async () => {
    try {
      ...
      let existingPage;
      try {
        existingPage = await investorsCmsApi.getPageContentBySlug('annual-return');
      } catch (e) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900">Annual Return Page CMS</h2>
        <p className="text-sm text-gray-600 mt-1">Manage documents for the Annual Return page</p>
      </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-4 mb-2">
                <input
                  ...
                  className="hidden"
                  id="annualReturnPdfUpload"
                  disabled={uploadingPdf}
                />
                <label
                  htmlFor="annualReturnPdfUpload"
