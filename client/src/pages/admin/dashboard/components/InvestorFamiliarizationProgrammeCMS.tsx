...
export default function InvestorFamiliarizationProgrammeCMS() {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900">Familiarization Programme Page CMS</h2>
        <p className="text-sm text-gray-600 mt-1">Manage documents for the Familiarization Programme page</p>
      </div>
            ...
            <div className="md:col-span-2">
              ...
              <div className="flex items-center gap-4 mb-2">
                <input
                  ...
                  className="hidden"
                  id="familiarizationPdfUpload"
                  disabled={uploadingPdf}
                />
                <label
                  htmlFor="familiarizationPdfUpload"
