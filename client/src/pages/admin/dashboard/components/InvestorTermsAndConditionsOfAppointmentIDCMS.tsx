...
export default function InvestorTermsAndConditionsOfAppointmentIDCMS() {
  ...
  const handlePdfUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // Upload to terms-and-conditions-of-appointment-of-id subfolder
  ...
  const loadPageContent = async () => {
    try {
      ...
      if (err.message && !err.message.includes('Backend server not available')) {
        setError(err.message || 'Failed to load terms and conditions of appointment of ID page');
      }
  ...
  const handleSave = async () => {
    try {
      ...
      let existingPage;
      try {
        existingPage = await investorsCmsApi.getPageContentBySlug('terms-and-conditions-of-appointment-of-id');
      } catch (e) {
      ...
      if (existingPage && existingPage.id) {
        ...
        setSuccess('Terms and Conditions of Appointment of ID page updated successfully');
      } else {
        await investorsCmsApi.createPageContent(saveData);
        setSuccess('Terms and Conditions of Appointment of ID page created successfully');
      }
      ...
      setError(err.message || 'Failed to save terms and conditions of appointment of ID page');
    }
  };
    ...
    return (
      <div className="bg-white rounded-lg shadow-sm p-6">
        <div className="text-center py-12">
          ...
          <p className="mt-2 text-gray-600">Loading terms and conditions of appointment of ID page...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900">Terms and Conditions of Appointment of ID Page CMS</h2>
        <p className="text-sm text-gray-600 mt-1">Manage documents for the Terms and Conditions of Appointment of ID page</p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              placeholder="Terms and Conditions of Appointment of ID"
            />
          </div>
      ...
      <div className="mb-6">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-lg font-semibold text-gray-900">Documents ({pageContent.documents.length})</h3>
          <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="md:col-span-2">
              ...
              <input
                ...
                placeholder="e.g., Terms and Condition for Appointment of Independent Director"
              />
            </div>
            <div className="md:col-span-2">
              <label className="block text-sm font-medium text-gray-700 mb-2">
              ...
              <div className="flex items-center gap-4 mb-2">
                <input
                  ...
                  className="hidden"
                  id="termsConditionsPdfUpload"
                  disabled={uploadingPdf}
                />
                <label
                  htmlFor="termsConditionsPdfUpload"
