...
export default function InvestorStatementOfDeviationCMS() {
  ...
  const handlePdfUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // Upload to statement-of-deviation subfolder
  ...
  const handleSave = async () => {
    try {
      ...
      let existingPage;
      try {
        existingPage = await investorsCmsApi.getPageContentBySlug('statement-of-deviation');
      } catch (e) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900">Statement of Deviation Page CMS</h2>
        <p className="text-sm text-gray-600 mt-1">Manage documents for the Statement of Deviation page</p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              placeholder="Statement of Deviation"
            />
          </div>
            ...
            <div className="md:col-span-2">
              ...
              <div className="flex items-center gap-4 mb-2">
                <input
                  ...
                  className="hidden"
                  id="statementDeviationPdfUpload"
                  disabled={uploadingPdf}
                />
                <label
                  htmlFor="statementDeviationPdfUpload"
