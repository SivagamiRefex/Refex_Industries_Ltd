...
export default function InvestorBookClosureCMS() {
  ...
  const handlePdfUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // Upload to book-closure subfolder
  ...
  const handleSave = async () => {
    try {
      ...
      let existingPage;
      try {
        existingPage = await investorsCmsApi.getPageContentBySlug('book-closure-of-members-register-record-date');
      } catch (e) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900">Book Closure of Members Register / Record Date Page CMS</h2>
        <p className="text-sm text-gray-600 mt-1">Manage documents for the Book Closure page</p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              placeholder="Book Closure of Members Register / Record Date"
            />
          </div>
            ...
            <div className="md:col-span-2">
              ...
              <div className="flex items-center gap-4 mb-2">
                <input
                  ...
                  className="hidden"
                  id="bookClosurePdfUpload"
                  disabled={uploadingPdf}
                />
                <label
                  htmlFor="bookClosurePdfUpload"
