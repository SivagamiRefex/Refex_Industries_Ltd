...
export default function InvestorSchemeOfAmalgamationArrangementCMS() {
  ...
  const handlePdfUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // Upload to scheme-of-amalgamation-arrangement subfolder
  ...
  const handleSave = async () => {
    try {
      ...
      let existingPage;
      try {
        existingPage = await investorsCmsApi.getPageContentBySlug('scheme-of-amalgamation-arrangement');
      } catch (e) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900">Scheme of Amalgamation Arrangement Page CMS</h2>
        <p className="text-sm text-gray-600 mt-1">Manage documents for the Scheme of Amalgamation Arrangement page</p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              placeholder="Scheme of Amalgamation / Arrangement"
            />
          </div>
