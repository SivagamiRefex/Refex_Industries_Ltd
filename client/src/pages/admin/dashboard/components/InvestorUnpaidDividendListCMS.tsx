...
export default function InvestorUnpaidDividendListCMS() {
  ...
  const handlePdfUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // Upload to unpaid-dividend-list-and-iepf-shares subfolder
  ...
  const handleSave = async () => {
    try {
      ...
      let existingPage;
      try {
        existingPage = await investorsCmsApi.getPageContentBySlug('unpaid-dividend-list-and-iepf-shares');
      } catch (e) {
        // Page doesn't exist yet
      }

      if (existingPage && existingPage.id) {
        await investorsCmsApi.updatePageContent(existingPage.id, pageData);
        setSuccess('Unpaid Dividend List page updated successfully');
      } else {
        await investorsCmsApi.createPageContent(pageData);
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900">Unpaid Dividend List and IEPF Shares Page CMS</h2>
        <p className="text-sm text-gray-600 mt-1">Manage Nodal Officer information and documents for the Unpaid Dividend List page</p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              placeholder="Unpaid Dividend List and IEPF Shares"
            />
          </div>
      ...
      <div className="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Nodal Officer Information</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div key={docIndex} className="flex items-center justify-between p-3 bg-gray-50 rounded border border-gray-200">
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500">
                    {doc.date && `Date: ${doc.date} | `}Year: {doc.year}
                  </p>
                </div>
            ...
            <div className="md:col-span-2">
              ...
              <div className="flex items-center gap-4 mb-2">
                <input
                  ...
                  className="hidden"
                  id="unpaidDividendPdfUpload"
                  disabled={uploadingPdf}
                />
                <label
                  htmlFor="unpaidDividendPdfUpload"
