...
export default function InvestorCreditRatingsCMS() {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900">Credit Ratings Page CMS</h2>
        <p className="text-sm text-gray-600 mt-1">Manage documents for the Credit Ratings page</p>
      </div>
      ...
      <div className="mb-6">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-lg font-semibold text-gray-900">Credit Ratings ({pageContent.documents.length})</h3>
          <button
        ...
        {pageContent.documents.length === 0 ? (
          <div className="text-center py-8 text-gray-500">
            No credit ratings found. Click "Add Credit Rating" to create one.
          </div>
        ) : (
          <div className="space-y-2">
      ...
      {showDocumentForm && editingDocument && editingDocument.document && (
        <div className="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
          <h4 className="text-md font-semibold text-gray-900 mb-4">
            {editingDocument.documentIndex >= 0 ? 'Edit Credit Rating' : 'Add New Credit Rating'}
          </h4>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className={pageContent.hasYearFilter ? '' : 'md:col-span-2'}>
              ...
              <div className="flex items-center gap-4 mb-2">
                <input
                  ...
                  className="hidden"
                  id="creditRatingPdfUpload"
                  disabled={uploadingPdf}
                />
                <label
                  htmlFor="creditRatingPdfUpload"
